[![Build Status](https://travis-ci.org/eddiejaoude/zf2-logger.svg?branch=multiple-php-versions)](https://travis-ci.org/eddiejaoude/zf2-logger)
[![Coverage Status](https://coveralls.io/repos/eddiejaoude/zf2-logger/badge.png?branch=master)](https://coveralls.io/r/eddiejaoude/zf2-logger?branch=multiple-php-versions)
